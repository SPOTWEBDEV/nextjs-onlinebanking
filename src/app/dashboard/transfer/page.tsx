...
export default function TransferPage() {
  ...
  const transferMutation = useMutation({
    ...
    onSuccess: (_data, variables) => {
      ...
      const recipient = beneficiaries?.find((b) => b.id === variables.beneficiaryId);
      showLocalNotification(
        "Transfer sent",
        `${formatCurrency(variables.amount)} to ${recipient?.name ?? "beneficiary"}`
      );
    },
  });
  ...
  return (
    <div>
      <TopNav title={t.pages.transfer} back />
